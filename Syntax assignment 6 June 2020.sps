...
save results /outfile= '/Users/ka5604em/Documents/SIMM23:SAKA003/Assignment 6/screedata2.sav' / var=root rawdata means percntyl .

end matrix.

* plots the eigenvalues, by root, for the real/raw data and for the random data.
GET file= '/Users/ka5604em/Documents/SIMM23:SAKA003/Assignment 6/screedata2.sav' .
TSPLOT VARIABLES= rawdata means percntyl /ID= root /NOLOG.

*Run EFA, Eigenvalue > 1 criteria, orthogonal rotation (Varimax)
...
*Run EFA, 4 factors, orthogonal rotation (Varimax)
...
*Run EFA, 3 factors,  orthogonal rotation (Varimax)
...
*Run EFA, 3 factors, oblique rotation (Promax)
...
*Run EFA, 3 factors, oblique rotation (Promax), plus removed item 28
...
*Run EFA, 3 factors, oblique rotation (Promax), plus removed item 28 and 1

FACTOR
  /VARIABLES ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 ar18 ar19 ar20 
    ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /MISSING LISTWISE 
...
*Run EFA, 3 factors, oblique rotation (Promax), plus removed item 28, 1 and 16

FACTOR
  /VARIABLES ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar18 ar19 ar20 ar21 
    ar22 ar23 ar24 ar25 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar18 ar19 ar20 ar21 
    ar22 ar23 ar24 ar25 ar26 ar27
  /PRINT INITIAL KMO EXTRACTION ROTATION
  /FORMAT SORT
  /PLOT EIGEN
...
*Run EFA, 3 factors, oblique rotation (Promax), plus removed item 28, 1, 14 and 16

FACTOR
  /VARIABLES ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar21 ar22 
    ar23 ar24 ar25 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar21 ar22 
    ar23 ar24 ar25 ar26 ar27
  /PRINT INITIAL KMO EXTRACTION ROTATION
  /FORMAT SORT
  /PLOT EIGEN
...
*Run EFA, 3 factors, oblique rotation (Promax), plus removed item 28, 1, 14, 16 and 25
...
*Run EFA, 3 factors, oblique rotation (Promax), plus removed item 28, 1, 14, 16, 25 and 11

FACTOR
  /VARIABLES ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar21 ar22 ar23 
    ar24 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar21 ar22 ar23 
    ar24 ar26 ar27
  /PRINT INITIAL KMO EXTRACTION ROTATION
  /FORMAT SORT
  /PLOT EIGEN
...
*Run EFA, 3 factors, oblique rotation (Promax), plus removed item 28, 1, 14, 16, 25, 11 and 8

FACTOR
  /VARIABLES ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar21 ar22 ar23 
    ar24 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar21 ar22 ar23 ar24 
    ar26 ar27
  /PRINT INITIAL KMO EXTRACTION ROTATION
  /FORMAT SORT
  /PLOT EIGEN
...
*Run EFA, 3 factors, oblique rotation (Promax), plus removed item 28, 1, 14, 16, 25, 11, 8 and 24
...
*Run EFA, 3 factors, oblique rotation (Promax), plus removed item 28, 1, 14, 16, 25, 11, 8 and 24, saving factors scores
...
*Run EFA, 3 factors, orthogolan rotation (varimax), plus removed item 28, 1, 14, 16, 25, 11, 8 and 24, 
